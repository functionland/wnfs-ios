#
#  Be sure to run `pod spec lint WnfsSwift.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  A wrapper around the WNFS swift bindings
  DESC
  ...
  spec.dependency "WnfsBindings", '0.1.6'
